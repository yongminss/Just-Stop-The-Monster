// MainGame.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= NULL;// MAKEINTRESOURCEW(IDC_MAINGAME);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, Style, CW_USEDEFAULT,
   ...
   net_manager->rq_connect_server("127.0.0.1");
   WSAAsyncSelect(net_manager->m_serverSocket, hWnd, WM_SOCKET, FD_READ || FD_CLOSE);
